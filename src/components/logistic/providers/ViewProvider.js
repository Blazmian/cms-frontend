    ...
    return (
        <>
            ...
            <Container fluid className='m-0 pt-4 px-4 pb-3 d-flex align-items-center'>
                ...
                />
                <Container fluid>
                <h4 className={'fw-bold'} >Nombre del la empresa</h4>
                    <h4 className={'fw-bold'} >Manuel Jumenez</h4>
                    <h4 className='fs-4' style={{ textAlign: 'justify' }}>Productos</h4>
                </Container>
            </Container>
            <CDBBox style={{ fontSize: '13px', marginBottom: '10px' }} display='flex' flex='fill' alignItems='center'>
                ...
                <h5 className='fs-5' style={{ textAlign: 'justify' }}>manuel.jimenez@gmail.com</h5>
            </CDBBox>
            <CDBBox style={{ fontSize: '13px', marginBottom: '10px' }} display='flex' flex='fill' alignItems='center'>
            ...
            <CDBBox style={{ fontSize: '13px', marginBottom: '10px' }} display='flex' flex='fill' alignItems='center'>
                <h5 className={'fw-bold fs-5 me-3'} style={{ marginLeft: '35px' }}>Direccion:  </h5>
                <h5 className='fs-5' style={{ textAlign: 'justify' }}>Bacum 354</h5>
            </CDBBox>
            <Container fluid>
            ...
            <Button variant="primary" style={{ marginLeft: '1100px', marginTop: '15px' }}>Editar</Button>
        </>
    )
}
